                        ...
                        <p class="text-muted page-title-alt"></p>
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xs-12" style="/*margin-bottom: 50px;*/">
									...
									<div class="text-center textvoicebox col-sm-1 col-md-1 col-lg-1 col-xs-12">
										...
										<h3><?php echo $groupmember[$i]['percentage']; if($groupmember[$i]['percentage']!="NA") { echo "%"; } ?></h3>
										...
										<?php if(!empty($groupmember[$i]['voice_rating'])){ ?>
											<a href="<?php echo base_url(); ?>addrating?id=<?php echo $groupmember[$i]['id']; ?>&type=voice<?php echo $query_string; ?>"><button class="voicecomplete btn" style="background: #1a53ff;">Voice</button></a>
										<?php }else{ ?>
										...
										<?php } ?>
										<?php if(isset($groupmember[$i]['user_percentage'])){
									...
									<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 ">
										...
										<div class="textvoicebox col-sm-1 col-md-1 col-lg-1 col-xs-12">
											...
											<h3><?php echo $groupmember2[$i]['percentage']; if($groupmember2[$i]['percentage']!="NA") { echo "%"; } ?></h3>
											...
											<?php if(!empty($groupmember2[$i]['voice_rating'])){ ?>
												<a href="<?php echo base_url(); ?>addrating?id=<?php echo $groupmember2[$i]['id']; ?>&type=voice<?php echo $query_string; ?>"><button class="voicecomplete btn" style="background: #1a53ff;">Voice</button></a>
											<?php }else{ ?>
												<a href="<?php echo base_url(); ?>addrating?id=<?php echo $groupmember2[$i]['id']; ?>&type=voice"><button class="voicepending btn" style="<?php echo $style; ?>">Voice</button></a>
											<?php } ?>
