								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xs-12" style="/*margin-bottom: 50px;*/">
									...
									<div class="text-center textvoicebox col-sm-1 col-md-1 col-lg-1 col-xs-12">
										...
										<?php if(!empty($groupmember[$i]['voice_rating'])){ ?>
											<a href="<?php echo base_url(); ?>addrating?id=<?php echo $groupmember[$i]['id']; ?>&type=voice<?php echo $query_string; ?>"	><button class="voicecomplete btn" style="background: #00a900;">Voice</button></a>
										<?php }else{ ?>
											<a href="<?php echo base_url(); ?>addrating?id=<?php echo $groupmember[$i]['id']; ?>&type=voice" style="<?php echo $style; ?>"	><button class="voicepending btn">Voice</button></a>
										<?php } ?>
									...
									<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 ">
										...
										<div class="textvoicebox col-sm-1 col-md-1 col-lg-1 col-xs-12">
											...
											<?php if(!empty($groupmember[$i]['text_assessed_rating']) && !empty($groupmember[$i]['voice_assessed_rating'])){ ?>
												<i class="fa fa-user" style="width:100%;font-size: 90px;color: darkseagreen;"></i>
											<?php }else{ ?>
												<i class="fa fa-user" style="width:100%;font-size:90px;color: 2f2f2f;"></i>
											<?php } ?>
											<?php if(!empty($groupmember[$i]['text_assessed_rating'])){ ?>
											...
											<?php } ?>
											<?php if(!empty($groupmember[$i]['voice_assessed_rating'])){ ?>
