		   ...
		   ?>
            <div class="content">
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <h4 class="page-title">vb starter View Paused Account</h4>
						...
						<table class="table table-hover">
							...
							<?php  for($i=0;$i<sizeof($data);$i++){ ?>
							  <tr>
								...
								<td><?php if($data[$i]['status']==0){ echo "Pause"; }else{ echo "Resume"; } ?></td>
								...
								<?php if($data[$i]['status']==0){ ?>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>admin/resume_account/<?php echo $data[$i]['id']; ?>">Resume Account</a>
								<?php } ?>
								</td>
							  </tr>
							<?php } ?>
