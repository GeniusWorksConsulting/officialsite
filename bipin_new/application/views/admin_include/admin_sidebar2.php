<div class="left side-menu col-sm-3 col-md-3 col-lg-2" style="background:#3A4B55;">
            ...
            <ul>
                ...
                <?php if ($_SESSION['role'] == 1 || $_SESSION['role'] == 49) { ?>
                    ...
                    <li class="has_sub">
                        ...
                        ?>" data-id="user"><i class="fa fa-user" aria-hidden="true"></i> <span> Tribe Member </span> <span class="menu-arrow"></span> </a>
                ...
                <?php if ($_SESSION['role'] == 1) { ?>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect opensub <?php
                        if ($active_page == "qamember") {
                            echo "active";
                        }
                        ?>" data-id="qamember"><i class="fa fa-user" aria-hidden="true"></i> <span> QA Member </span> <span class="menu-arrow"></span> </a>
                    ...
                    <li class="has_sub">
                        <a href="<?= base_url() ?>admin/paused_account" class="waves-effect <?php
                        if ($active_page == "paused_account") {
                            echo "active";
                        }
                        ?>"><i class="fa fa-dashboard"></i> <span> Paused Account </span> </a>

                    </li>
                    <li class="has_sub">
                        <a href="<?= base_url() ?>admin/view_previous" class="waves-effect <?php
                        if ($active_page == "viewprevious") {
                            echo "active";
                        }
                        ?>"><i class="fa fa-dashboard"></i> <span> View Previous </span> </a>
                    </li>

                <?php } ?>
                <?php if ($_SESSION['role'] == 2) { ?>
                    <li class="has_sub">
                        <a href="<?= base_url() ?>newdashboard" class="waves-effect <?php
                        if ($active_page == "dashboard") {
                            echo "active";
                        }
                        ?>"><i class="fa fa-dashboard"></i> <span> Dashboard </span> </a>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect opensub <?php
                        if ($active_page == "changepassword") {
                            echo "active";
                        }
                        ?>" data-id="changepassword"><i class="fa fa-user" aria-hidden="true"></i> 
                    ...
                    <li class="has_sub">
                        <a href="<?= base_url() ?>pages/view_previous" class="waves-effect <?php
                        if ($active_page == "viewprevious") {
                            echo "active";
                        }
                        ?>"><i class="fa fa-dashboard"></i> <span> View Previous </span> </a>
                    ...
                    <li class="has_sub">
        <a href="javascript:void(0);" class="waves-effect opensub <?php
                    if ($active_page == "rating") {
                        echo "active";
                    }
                    ?>" data-id="rating"><i class="fa fa-user" aria-hidden="true"></i> <span> Rating </span> <span class="menu-arrow"></span> </a>
        <ul class="list-unstyled" id="rating">
            ...
            <li><a href="<?= base_url() ?>viewrating">View Rating</a></li>
                ...
                <?php if ($_SESSION['role'] == 49) { ?>
                    <li class="has_sub">
                        <a href="<?= base_url() ?>qamember/view_previous" class="waves-effect <?php
                        if ($active_page == "viewprevious") {
                            echo "active";
                        }
                        ?>"><i class="fa fa-dashboard"></i> <span> View Previous </span> </a>
                ...
                ?>" data-id="setting"><i class="fa fa-user" aria-hidden="true"></i> <span> Settings </span> <span class="menu-arrow"></span> </a>
