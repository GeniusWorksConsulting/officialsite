            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12" style="margin-bottom: 50px;">
                        ...
                        if (sizeof($groupmember1) == 7) {
                            $textvoicebox = "textvoicebox2";
                        }
                                ...
                                <div class="text-center col-sm-12 col-md-12 col-lg-12 col-xs-12" style="margin-bottom: 50px;padding:0px;">
                                    ...
                                    for ($j = 0; $j < sizeof($groupmember1); $j++) {
                                        ...
                                        <div class="text-center <?php echo $textvoicebox; ?> col-sm-1 col-md-1 col-lg-1 col-xs-12">
                                            ...
                                            <h3><?php
                                                echo $groupmember1[$i][$j]['assessed_percentage'];
                                                if ($groupmember1[$i][$j]['assessed_percentage'] != "NA") {
                                                    echo "%";
                                                }
                                                ?></h3>
                                            <?php
                                            if ($groupmember1[$i][$j]['completed'] != "") {
                                                ?>
                                            ...
                                            <?php }
                                            ?>
                                            <h3 style="color:#1a53ff;margin: 0px;">&nbsp;<?php
                                                echo $groupmember1[$i][$j]['qarating'];
                                                if ($groupmember1[$i][$j]['qarating'] != "") {
                                                    echo "%";
                                                }
                                                ?></h3>
                                            <h5 style="color:#1a53ff;margin: 0px;">&nbsp;<?php
                                                if ($groupmember1[$i][$j]['qarating'] != "") {
                                                    echo "audited";
                                                }
                                                ?></h5>
                                            <?php
                                            if (!empty($groupmember1[$i][$j]['text_rating'])) {
                                                ?>
                                            ...
                                            <?php
                                            if (!empty($groupmember1[$i][$j]['voice_rating'])) {
                                                ?>
                                ...
                                <div class="text-center col-sm-12 col-md-12 col-lg-12 col-xs-12" style="margin-bottom: 50px;padding:0px;">
                                    ...
                                    for ($j = 0; $j < sizeof($groupmember2); $j++) {
                                        ...
                                        <div class="text-center <?php echo $textvoicebox; ?> col-sm-1 col-md-1 col-lg-1 col-xs-12">
                                            ...
                                            <h3><?php
                                                echo $groupmember2[$i][$j]['assessed_percentage'];
                                                if ($groupmember2[$i][$j]['assessed_percentage'] != "NA") {
                                                    echo "%";
                                                }
                                                ?></h3>

                                            <?php
                                            if ($groupmember2[$i][$j]['completed'] != "") {
                                                ?>
                                                <i class="fa fa-user" style="width:100%;font-size: 90px;color: #aef5ae;;"></i>
                                                <?php
                                            } else {
                                            ...
                                            ?>
                                            <h3 style="color:#1a53ff;margin: 0px;">&nbsp;<?php
                                                echo $groupmember2[$i][$j]['qarating'];
                                                if ($groupmember2[$i][$j]['qarating'] != "") {
                                                    echo "%";
                                                }
                                                ?></h3>
                                            <h5 style="color:#1a53ff;margin: 0px;">&nbsp;<?php
                                            ...
                                            <?php
                                            if (!empty($groupmember2[$i][$j]['text_rating'])) {
                                                ?>
                                            ...
                                            <?php
                                            if (!empty($groupmember2[$i][$j]['voice_rating'])) {
                                                ?>
