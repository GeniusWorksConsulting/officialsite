...
<div class="container">
   <div class="row">
    ...
    <tbody>
		<?php for($i=0;$i<sizeof($getallusers);$i++){
			?>
			<tr>
				<td><?php echo $i+1; ?></td>
				<td><?php echo $getallusers[$i]['first_name']; ?></td>
				<td><?php echo $getallusers[$i]['last_name']; ?></td>
				<td><?php echo $getallusers[$i]['email']; ?></td>
				<td><?php echo $getallusers[$i]['phoneno']; ?></td>
				<td><?php echo $getallusers[$i]['group_name']; ?></td>
				<td>
					<a href="<?php echo base_url(); ?>admin/adduser?id=<?php echo $getallusers[$i]['id']; ?>" class="btn btn-primary">Edit</a>
					<a href="<?php echo base_url(); ?>admin/deleteuser?id=<?php echo $getallusers[$i]['id']; ?>" class="btn btn-danger">Delete</a>
				</td>
			  </tr>
			<?php
		}?>
