                            ...
                            for ($i = 0; $i < sizeof($data); $i++) {
                                if ($data[$i]['id'] > 3) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>pages/newdashboard?week=<?php echo $data[$i]['week']; ?>&month=<?php echo $data[$i]['month']; ?>&year=<?php echo $data[$i]['year']; ?>" class="btn btn-primary">View</a>
                                        </td>
                                    </tr>
                                <?php }
                            }
