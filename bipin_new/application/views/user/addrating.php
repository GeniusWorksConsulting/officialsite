...
/* Tooltip text */
.sanjay_tooltip .sanjay_tooltiptext {
    visibility: hidden;
    width: 100%;
...
.sanjay_tooltip:hover .sanjay_tooltiptext {
    visibility: visible;
}
</style>
		  ...
		  <div class="row">
			<div class="col-sm-4 col-md-4 col-lg-4 col-xs-12 text-center">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
					<a href="<?php echo base_url()."optionvoicerating?id=".$userdata_get[0]['id']."&type=voice"; ?>">
						...
						<?php
							...
							$j++;
                                ...
                                for ($i = 0; $i < sizeof($getallcatageory); $i++) {
                                    ?>
                                    <h3 style="background: burlywood;text-align:center;"><?php echo $getallcatageory[$i]['name']; ?></h3>
                                    <div>
                                        <?php
                                        $CI = & get_instance();
                                        ...
                                        for ($j = 0; $j < sizeof($question); $j++) {
                                            ...
                                            if ($question[$j]['isparent'] == "parent") {
                                                ...
                                                ?>
                                                <div >
                                                    <h4><span class="sanjay_tooltip">Q. <?php echo $question[$j]['description'] ?><?php if($question[$j]['evaluation'] != ""){ ?><span class="sanjay_tooltiptext"><?php echo $question[$j]['evaluation']; ?></span><?php } ?></span></h4>
                                                    <input type="hidden" name="question_ids[]" value="<?php echo $question[$j]['que_id']; ?>">
                                                    <input type="hidden" name="weighting_ids[]" value="<?php echo $question[$j]['weighting']; ?>">
                                                    <input type="hidden" name="cat_ids[]" value="<?php echo $getallcatageory[$i]['id']; ?>">
                                                    ...
                                                    <select name="ans_values[]" id="parent_<?php echo $question[$j]['que_id']; ?>" class="parent <?php echo $has_child_class; ?> form-control" data-parent="<?php echo $question[$j]['que_id'] ?>" name="answer" >
                                                       <option value="0">Select</option>
                                                        ...
                                                        for ($k = 0; $k < sizeof($answer); $k++) {
                                                            ?>
                                                            <option value="<?php echo $answer[$k]['weighting']; ?>">
...
function ratingchange(categoryid)
{
 ...
 $('.parent').change(function(){
    ...
    if($(this).hasClass('has_child')){
        if(text == "Yes" || text == "Yes, It Was A Complaint"){
