 ...
 */
$config['site_title'] = "Social OS";       // Site Title, example.com
$config['admin_email'] = "signup@geniusworks.co.za"; // Admin Email, admin@example.com
$config['default_group'] = 'qamember';           // Default group, use name
...
$config['email_config'] = array(
    'mailtype' => 'html',
    'protocol' => 'smtp',
    'smtp_host' => 'foop.aserv.co.za',
    'smtp_port' => '587',
    'smtp_user' => 'signup@geniusworks.co.za',
    'smtp_pass' => 'Genius862',
    'charset' => 'iso-8859-1'
);
