...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<?= site_url('qamember/viewPrevious') ?>">View Previous</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="text-semibold"><?= get_squadgroup_helper(array('squad_group' => $squad->squad_group)) . ' - ' . $this->logged_in_name; ?></h6>
                                </div>
                                ...
                                <ul class="info-blocks">
                                    ...
                                    <?php foreach ($members as $m) { ?>
                                        <li class="bg-default">
                                            ...
                                            <img alt="Profile" class="media-object thumbnail-boxed margin-bottom" src="<?= base_url('profile/' . $m->profile); ?>" onerror="this.src='http://localhost/engage/assets/images/user.png';">
