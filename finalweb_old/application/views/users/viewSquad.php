...
<div class="row">
    <div class="col-sm-12 text-right">  
        <a class="btn btn-success btn-sm" href="<?= site_url('users/addSquad') ?>"><i class="icon-plus-circle"></i> ADD SQUAD</a>
    </div>
</div>
<br>
    ...
    <tbody>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td><a title="edit" href="<?= site_url('users/editSquad/' . $user->id) ?>"><i class="icon-pencil3"></a></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
