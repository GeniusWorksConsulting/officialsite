...
<div class="row">
    <div class="col-sm-12 text-right">  
        <a class="btn btn-success btn-sm" href="<?= site_url('admin/addquestion') ?>"><i class="icon-plus-circle"></i> ADD</a>
    </div>
</div>
<br>
        ...
        <tbody>
            <?php foreach ($list as $q) { ?>
                <tr>
                    ...
                    <td class="text-right">
                        <!--<a title="Edit" class="" href="<?= site_url('admin/addquestion/' . $q->question_id) ?>"><i class="icon-pencil3"></i></a>&nbsp;|-->
                        <a title="Delete" onclick="return confirm('Want to delete?');" class="text-danger" href="<?= site_url('admin/deletequestion/' . $q->question_id) ?>"><i class="icon-remove2"></i></a>
                    </td>
                </tr>
            <?php }
            ?>
