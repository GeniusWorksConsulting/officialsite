...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<?= site_url('admin/viewScheduler') ?>">Manage Scheduler </a></li>
        <li class="active">Add Scheduler</li>
    </ul>
</div>
<!-- /breadcrumbs line -->
...
<div class="row">
    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
        <h1>Scheduler Member</h1>
        <div class="panel panel-default">
            <!--<div class="panel-heading"><h6 class="panel-title">Invoice</h6></div>-->
            <div class="panel-body">
                <?php
                $attributes = array('id' => 'formSchedular', 'name' => 'formSchedular', 'class' => 'form-bordered');
                echo form_open('admin/addScheduler', $attributes);
                ?>
