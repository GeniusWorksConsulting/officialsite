...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">View QA Member</li>
    </ul>
</div>
<!-- /breadcrumbs line -->
...
<div class="row">
    <div class="col-sm-12 text-right">  
        <a class="btn btn-success btn-sm" href="<?= site_url('admin/addQA') ?>"><i class="icon-plus-circle"></i> ADD QA</a>
    </div>
</div>
<br>
    ...
    <tbody>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td><a title="edit" href="<?= site_url('admin/editQA/' . $user->id) ?>"><i class="icon-pencil3"></a></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
