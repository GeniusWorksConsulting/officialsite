...
<div class="navbar navbar-inverse" role="navigation">
    ...
    <ul class="nav navbar-nav collapse" id="navbar-menu">
        <li title="Dashboard" class="<?php if ($uri_seg_val == "new_dashboard") echo "active"; ?>">
            <a href="<?= site_url('squad/new_dashboard') ?>">
                <i class="icon-home2"></i>
            </a>
        </li>
        <li title="Assessment" class="<?php if ($uri_seg_val == "assessment_new") echo "active"; ?>">
            <a href="<?= site_url('squad/assessment_new') ?>">
...
<div class="navbar navbar-default" role="navigation">
    ...
    <ul class="nav navbar-nav collapse" id="navbar-menu-left">
        ...
        <li title="Assessment" class="<?php if ($uri_seg_val == "assessment_new" or $uri_seg_val == "addrating") echo "active"; ?>">
            <a href="<?= site_url('squad/assessment_new') ?>">
                Assessments
            </a>
        </li>
