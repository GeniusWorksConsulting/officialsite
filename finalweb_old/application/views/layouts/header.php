...
<div class="sidebar">
    <div class="sidebar-content">
        ...
        <?php if ($this->ion_auth->in_group(array('qamember', 'lead'))) { ?>
            <!-- Main navigation -->
            <ul class="navigation">
                <li title="Dasbboard" class="<?php if ($uri_seg_val == "" or $uri_seg_val == "index") echo "active"; ?>">
                ...
                <?php if ($this->ion_auth->in_group(array('qamember'))) { ?>
                    <li title="View Score" class="<?php if ($uri_seg_val == "viewscore" || $uri_seg_val == "user_details") echo "active"; ?>">
                        <a href="<?= site_url('users/viewscore') ?>"><span>View Score</span><i class="icon-eye"></i> </a>
                    </li>
                <?php } ?>
            </ul>
            <!-- /main navigation -->
