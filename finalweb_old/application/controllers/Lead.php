...
class Lead extends CI_Controller {
    ...
    public function __construct() {
        ...
        if (!$this->ion_auth->in_group($group)) {
            ...
            $this->session->set_flashdata('message', 'You must be an Lead Member to view the user groups page.');
            redirect('auth/login');
        }
    ...
    public function viewcategory() {
        ...
        $this->data['body'] = 'lead/viewcategory';
        $this->load->view('layouts/main', $this->data);
    }
    ...
    public function addcategory($cat_id = null) {
        ...
        $this->data['body'] = 'lead/addcategory';
        $this->load->view('layouts/main', $this->data);
    }
    ...
    public function viewquestion() {
        ...
        $this->data['body'] = 'lead/viewquestion';
        $this->load->view('layouts/main', $this->data);
    }
    ...
    public function addquestion($question_id = null) {
        ...
        $this->data['body'] = 'lead/addquestion';
        $this->load->view('layouts/main', $this->data);
    }
    ...
    public function saveQuestion() {
        ...
        $this->form_validation->set_rules('weight', 'weight', 'required|numeric', array('required' => 'Please enter the weight of question'));
        $this->form_validation->set_rules('no_answer', "no_answer", "required|numeric", array('required' => 'Please enter atlease one answer'));
    ...
    public function addSquad() {
        ...
        if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data, array(3))) {
            ...
            redirect("lead/addSquad", 'refresh');
        } else {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($this->ion_auth->update($user->id, $data)) {
                    ...
                    $this->session->set_flashdata('message', $this->ion_auth->messages());
                    if ($this->ion_auth->is_qamember()) {
                        redirect('lead/viewSquad', 'refresh');
                    } else {
                        redirect('auth/login', 'refresh');
                    }
                } else {
    ...
    public function viewSquad() {
        $config['base_url'] = site_url('lead/viewSquad');
    ...
    public function activate($id, $code = FALSE) {
        ...
        } else if ($this->ion_auth->in_group('lead')) {
    ...
    public function deactivate($id = NULL) {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->data['body'] = 'lead/deactivate_user';
            $this->load->view('layouts/main', $this->data);
        } else {
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            for ($i = 0; $i < count($dataPost['question_id']); $i++) {
                if ($dataPost['has_child'][$i] != 1) {
                    $rating = $rating + $dataPost['answer'][$i];
                } else {
    ...
    public function change_password() {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            // render
            $this->data['body'] = 'lead/change-password';
            $this->load->view('layouts/main', $this->data);
        } else {
            ...
            if ($change) {
                ...
                $this->session->set_flashdata('message', $this->ion_auth->errors());
                redirect('lead/change_password', 'refresh');
            }
        }
    }
