...
<html lang="en">
    ...
    <body>
            ...
            <ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
                <li class="user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right icons-right" style="display: none;">
                        <li><a href="<?= site_url('admin/password') ?>"><i class="icon-lock"></i> Change Password</a></li>
        ...
        <!-- Small modal -->
        <div id="access_alert" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body with-padding">
                        <h6 class="text-danger text-smaller">
                            Alert
                        </h6>
                    </div>
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">You don't have permission to view this page.</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php if ($this->session->flashdata('access_alert')) { ?>
