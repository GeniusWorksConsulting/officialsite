...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<?= site_url('users/viewPrevious') ?>">View Previous</a></li>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h6 class="text-semibold"><?= get_squadgroup_helper(array('squad_group' => $squad->squad_group)); ?></h6>
                                    </div>
                                            ...
                                            <ul class="info-blocks">
                                                ...
                                                foreach ($members as $m1) {
                                                    ...
                                                    <li class="bg-default sminfo">
                                                        ...
                                                        <img alt="Profile" class="media-object thumbnail-boxed <?= (!$checkPaused1) ? 'border-red' : ''; ?>" src="<?= base_url('profile/' . $m1->profile); ?>" onerror="this.src='<?= base_url('assets/images/user.png'); ?>';">
                                                ...
                                                <ul class="info-blocks">
                                                    ...
                                                    foreach ($members as $m) {
                                                        ...
                                                        <li class="bg-default">
                                                            ...
                                                            <img alt="Profile" class="media-object thumbnail-boxed margin-bottom <?= (!$checkPaused) ? 'border-red' : ''; ?>" src="<?= base_url('profile/' . $m->profile); ?>" onerror="this.src='<?= base_url('assets/images/user.png'); ?>';">
