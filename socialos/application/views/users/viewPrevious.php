        ...
        <tbody>
            ...
            foreach ($list as $i) {
                ...
                <tr>
                    ...
                    echo form_open('users/viewAssessment', $attributes);
                    ?>
                    ...
                    <td class="text-right">
                        <button type="submit" title="View" class="btn btn-success btn-sm btn-icon" href="<?= site_url('users/addcategory/') ?>"><i class="icon-eye2"></i></button>
                    </td>
                    <?php echo form_close(); ?>
                </tr>
                <?php
