            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-6">
                            <label>Key:</label>
                            <input type="text" name="perm_key" id="perm_key" class="form-control" value="<?= $this->form_validation->set_value('perm_key'); ?>">
                            <span class="text-danger text-semibold"><?php echo form_error('perm_key'); ?></span>
                        </div>
                        <div class="col-sm-6">
                            <label>Name:</label>
                            <input type="text" name="perm_name" id="perm_name" class="form-control" value="<?= $this->form_validation->set_value('perm_name'); ?>">
