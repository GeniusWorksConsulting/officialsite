...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active text-first-letter"><?= $this->uri->segment(3); ?> Users</li>
    </ul>
</div>
<!-- /breadcrumbs line -->
...
<div class="row">
    <div class="col-md-10 col-xs-12">
        ...
        echo form_open('superadmin/search/' . $this->uri->segment(3), $attributes);
        ?>
        <div class="form-group">
            ...
            <div class="col-md-1">
                <a class="btn btn-danger btn-xs" href="<?= site_url('superadmin/users/' . $this->uri->segment(3)); ?>">Cancel</a>
            </div>
        </div>
        <?php echo form_close(); ?>
    </div>
    ...
    <!--<div class="col-md-2 text-right">
        <a class="btn btn-primary btn-xs" href="<?= site_url('superadmin/addQa') ?>"><i class="icon-plus-circle"></i> New QA</a>
    </div>-->
</div>
        ...
        foreach ($users as $user):
            ...
            <tr>
                ...
                <td class="text-center">
                    <label class="label label-success"><?= get_adminname_helper($user->admin_id); ?></label>
                </td>
                <td class="text-center">
                ...
                <td class="text-right">
                    <a title="edit" href="<?= site_url('superadmin/edit_user/' . $user->id) ?>"><i class="icon-pencil3"></i></a>
                </td>
            </tr>
        <?php endforeach; ?>
