...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<?= site_url($this->group_name . '/question') ?>">Questions</a></li>
    ...
    <div class="col-sm-10 col-sm-offset-1 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                echo form_open_multipart($this->group_name . '/add_que', $attributes);
                ?>
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <button name="btn-save" type="submit"  class="btn btn-xs btn-primary"><?= isset($row) ? 'UPDATE' : 'SUBMIT'; ?></button>
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>
