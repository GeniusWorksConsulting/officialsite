...
<div class="row">
    <div class="col-md-8 col-md-offset-2 col-xs-12">
        ...
        <h1 class="text-center">Admin User</h1>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                echo form_open('superadmin/addadmin', $attributes);
                ?>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="company" id="company" class="form-control" value="<?= $this->form_validation->set_value('company'); ?>">
                        </div>
                        <div class="col-sm-4">
