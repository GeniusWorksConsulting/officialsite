...
<div class="row">
    <div class="col-md-10 col-xs-12">
        ...
        echo form_open('superadmin/searchlead', $attributes);
        ?>
        <div class="form-group">
            ...
            <div class="col-md-2">
                ...
                <a class="btn btn-danger btn-xs" href="<?= site_url('superadmin/lead') ?>">Cancel</a>
            </div>
        </div>
        <?php echo form_close(); ?>
    </div>
    ...
    <div class="col-md-2 text-right">
        <a class="btn btn-primary btn-xs" href="<?= site_url('superadmin/addlead') ?>"><i class="icon-plus-circle"></i> Add</a>
    </div>
</div>
    ...
    <tbody>
        ...
        foreach ($users as $user):
            ...
            <tr>
                ...
                <td class="text-right">
                    <a title="edit" href="<?= site_url('superadmin/editlead/' . $user->id) ?>"><i class="icon-pencil3"></i></a>
                </td>
            </tr>
        <?php endforeach; ?>
