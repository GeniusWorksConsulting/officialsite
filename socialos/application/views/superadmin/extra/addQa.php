...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<?= site_url('superadmin/Qa') ?>">QA</a></li>
...
<div class="row">
    <div class="col-md-8 col-md-offset-2 col-xs-12">
        ...
        <h1 class="text-center">QA User</h1>
        <div class="panel panel-default">
            <!--<div class="panel-heading"><h6 class="panel-title">Invoice</h6></div>-->
            <div class="panel-body">
                <?php
                $attributes = array('id' => 'Qaform', 'name' => 'Qaform', 'class' => 'form-bordered');
                echo form_open('superadmin/addQa', $attributes);
                ?>
