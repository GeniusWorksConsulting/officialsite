...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        <li><a href="<?= site_url($this->group_name . '/index') ?>">Home</a></li>
        ...
        <div class="block">
            <div class="thumbnail">
                ...
                <div class="caption text-center">
                    <h6><?= $this->logged_in_name; ?> <small><?= $this->group_name; ?></small></h6>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-5">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <?php
                $attributes = array('id' => 'profile', 'name' => 'profile', 'class' => '');
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-6">
                            <button type="submit" name="btn_submit" class="btn btn-success btn-xs">Save</button>
                        </div>
                    </div>
                </div>
