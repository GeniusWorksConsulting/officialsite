        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub sanjay">
                    <a href="newdashboard" class="waves-effect <?php if($active_page == "dashboard") { echo "active"; } ?>"><i class="ti-home"></i> <span> Dashboard </span> </a>
                   
                </li>
				
				 <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect opensub <?php if($active_page == "profile") { echo "active"; } ?>" data-id="profile"><i class="fa fa-user" aria-hidden="true"></i> <span> Profile </span> <span class="menu-arrow"></span> </a>
