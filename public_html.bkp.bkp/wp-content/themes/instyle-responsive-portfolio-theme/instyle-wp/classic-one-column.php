<?php
/*
Template Name: Classic Portfolio One Column
*/
?>
<?php get_header(); ?>
...
<div class="span13 offset3" role="main">
    ...
    <div class="pagination filter">
        <ul>
            ...
            <?php
            if (!empty($xcludecat)) {$categories=  get_categories('taxonomy=skill-type&title_li=&exclude='.$xcludecat);}
    ...
    <div class="row gallery">
        ...
        <ul class="gallerycolumns">
            ...
            <li>
                <article id="post-<?php the_ID(); ?>" class="galleryitem1">	
                    <?php
                    if ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) { ?>
                    <div class="postheader">
                        <?php $image_id = get_post_thumbnail_id(); ?> 
                        <?php $image_url = wp_get_attachment_image_src($image_id,'full'); $image_url = $image_url[0]; ?>
                        <a href="<?php echo $image_url; ?>" rel="prettyPhoto[gallery]"><span class="overlay"></span><?php the_post_thumbnail('portfolio-large', array('class' => 'portfolio')); ?></a>
                    </div>
                    <?php } ?>
