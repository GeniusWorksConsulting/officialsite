...
define('CPTPATH', TEMPLATEPATH.'/inc/post-types-order');
                ...
                foreach( $post_types as $post_type_name ) 
                    {
                        ...
                        if ($post_type_name == 'post')
                            add_submenu_page('edit.php', 'Re-Order', 'Re-Order', 'manage_options', 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                        else
                            {
                                if (!is_post_type_hierarchical($post_type_name))
                                    add_submenu_page('edit.php?post_type='.$post_type_name, 'Re-Order', 'Re-Order', 'manage_options', 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                            }
		            }
	        }
