...
$prefix = 'thb-';
/***** Page MetaBox *****/ /* Not working */
/* $categories=  get_categories('taxonomy=skill-type&title_li=');
$meta_boxes[] = array(
	'id' => 'thb-page-portfolio',
	'title' => 'Portfolio Page Options <small>(applies only if this page is set a portfolio template)',
	'pages' => array('page'),
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => '<strong>Exclude Types</strong>',
			'id' => $prefix . 'xclude',
			'type' => 'taxonomy', // text box
			'desc' => 'If you want to exclude certain categories (Portfolio Types) from being listed in this portfolio page, choose the ones to be excluded.',
			'options' => array(
                'taxonomy' => 'skill-type',            // taxonomy name
...
// Portfolio Settings
$meta_boxes[] = array(
	'id' => 'thb-portfolio-options',
	'title' => 'Instyle - Portfolio Settings',
	'pages' => array('portfolio'),
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
				"name" =>  __('Portfolio Type', 'instyle'),
				"desc" => __('Choose the type of portfolio post you wish to display.', 'instyle'),
				"id" => $prefix.'switch',
				"type" => "select",
				"std" => 'Slideshow',
				"options" => array('Slideshow', 'Video', 'Audio', 'Image')
			),
		array(
				"name" =>  __('Enable Lightbox', 'instyle'),
				"desc" => __('Check this to enable the lightbox.', 'instyle'),
...
$meta_boxes[] = array(
	'id' => 'thb-portfolio-video',
	'title' => 'Instyle - Video',
	'pages' => array('portfolio'),
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Video Height','instyle'),
				"desc" => __('Height of the video','instyle'),
				"id" => $prefix."portfolio-video-height",
				"type" => "text"
			),
		array( "name" => __('M4V File URL','instyle'),
				"desc" => __('The URL to the .m4v video file','instyle'),
				"id" => $prefix."portfolio-video-m4v",
				"type" => "text"
			),
		array( "name" => __('OGV File URL','instyle'),
				"desc" => __('The URL to the .ogv video file','instyle'),
				"id" => $prefix."portfolio-video-ogv",
				"type" => "text"
			),
		array( "name" => __('Poster Image','instyle'),
				"desc" => __('The preview image.','instyle'),
				"id" => $prefix."portfolio-video-poster",
				"type" => "text"
			),
		array( "name" => __('Embeded Code','instyle'),
				"desc" => __('If you\'re not using self hosted video then you can include embeded code here. Best viewed at 760px wide.','instyle'),
				"id" => $prefix."portfolio-video-embed",
				"type" => "textarea"
			)
...
$meta_boxes[] = array(
	'id' => 'thb-portfolio-audio',
	'title' => 'Instyle - Audio',
	'pages' => array('portfolio'),
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('MP3 File URL','instyle'),
				"desc" => __('The URL to the .mp3 audio file','instyle'),
				"id" => $prefix."portfolio-audio-mp3",
				"type" => "text"
			),
		array( "name" => __('OGA File URL','instyle'),
				"desc" => __('The URL to the .oga, .ogg audio file','instyle'),
				"id" => $prefix."portfolio-audio-ogg",
				"type" => "text"
			)
...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
			'name' => __('<strong>Link URL</strong>','instyle'),
			'desc' => __('<small>Where do you want to link to?</small>','instyle'),
			'id' => $prefix . 'link-url',
			'type' => 'text'		
		),
		array(
			'name' => __('<strong>Link Title</strong>','instyle'),
			
			'desc' => __('<small>Whats the title of the link?</small>','instyle'),
			'id' => $prefix . 'link-url-title',
			'type' => 'text'
		)
...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
			'name' => __('<strong>Quote</strong>','instyle'),
			'desc' => __('Write your quote in this field</small>','instyle'),
			'id' => $prefix . 'quote',
			'type' => 'textarea'	
		)
...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array( "name" => __('Embeded Code','instyle'),
				"desc" => __('If you\'re not using self hosted video then you can include embeded code here. Best viewed at 520px wide.','instyle'),
