      ...
      <div class="element">
        ...
        // loop through options array
          ...
          $checked = '';
	        ...
	        echo '<div class="input_wrap"><input name="'.$value[item_id].'" id="'.$value[item_id].'_'.$count.'" type="checkbox" value="'.trim( $option ).'"'.$checked.' /><label for="'.$value[item_id].'_'.$count.'">'.trim( $option ).'</label></div>';
	        $count++;
     		}
        ?>
      </div>
