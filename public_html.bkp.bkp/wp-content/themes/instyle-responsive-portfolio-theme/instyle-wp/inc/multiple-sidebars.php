		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>
						Select the sidebar you wish to display on this page, and which sidebar it will replace. <strong>Note:</strong> You must first create the sidebar under Appearance > Sidebars. 
					</p>
					<ul>
					<?php 
