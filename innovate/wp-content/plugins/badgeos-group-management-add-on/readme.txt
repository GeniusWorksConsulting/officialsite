...
*Note:* You will need the free [BadgeOS plugin](http://wordpress.org/extend/plugins/badgeos/ "BadgeOS")&trade; (version 1.4.8 or higher).

[Get the BadgeOS plugin](http://wordpress.org/extend/plugins/badgeos/ "BadgeOS").

   Features:*

   *   Create and manage as many Groups as desired
   *   Assign administrators to Groups, to create and manage achievements
   *   Create group managers (teachers), and add their students to the group
