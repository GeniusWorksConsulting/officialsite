...
new WPUpdatesPluginUpdater_1304( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1304') ) {
    class WPUpdatesPluginUpdater_1304 {
